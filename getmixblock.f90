...
!-----------------------------------------------
      INTEGER :: K, IERR, IOS, NCFTOT, NVECTOT, NVECSIZ, NBLOCK, I,    &
                 NVECPAT, NCFPAT, NVECSIZPAT, NEAVSUM, JB, NB, NCFBLK, &
                 NEVBLK, IATJP, IASPA, J
      REAL(DOUBLE)       :: EAVSUM
...
!           ...Construct the true energy by adding up the average
            EVAL(NVECPAT+1:NEVBLK+NVECPAT) =                           &
                                  EVAL(NVECPAT+1:NEVBLK+NVECPAT) + EAV
